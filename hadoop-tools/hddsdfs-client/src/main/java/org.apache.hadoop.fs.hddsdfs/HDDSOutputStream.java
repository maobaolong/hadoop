 ...
 */
public class HDDSOutputStream extends OutputStream {
  ...
  public static final Logger LOG =
      LoggerFactory.getLogger(HDDSOutputStream.class);
  ...
  public static class Builder {
    ...
    public Builder setOmClient(DFSClient client) {
