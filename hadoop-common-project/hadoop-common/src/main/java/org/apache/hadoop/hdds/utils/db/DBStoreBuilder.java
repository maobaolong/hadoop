...
import static org.apache.hadoop.hdds.utils.db.HddsConfigKeys.HDDS_DB_PROFILE;
import static org.apache.hadoop.hdds.utils.db.HddsConfigKeys.HDDS_DEFAULT_DB_PROFILE;
import static org.apache.hadoop.hdds.utils.db.OzoneConfigKeys.OZONE_METADATA_STORE_ROCKSDB_STATISTICS;
import static org.apache.hadoop.hdds.utils.db.OzoneConfigKeys.OZONE_METADATA_STORE_ROCKSDB_STATISTICS_DEFAULT;
import static org.apache.hadoop.hdds.utils.db.OzoneConfigKeys.OZONE_METADATA_STORE_ROCKSDB_STATISTICS_OFF;
...
public final class DBStoreBuilder {
  ...
  private void processTables() throws IOException {
    ...
    addTable(ByteUtil.bytes2String(RocksDB.DEFAULT_COLUMN_FAMILY),
        dbProfile.getColumnFamilyOptions());
    LOG.info("Using default column profile:{} for Table:{}",
        dbProfile.toString(),
        ByteUtil.bytes2String(RocksDB.DEFAULT_COLUMN_FAMILY));
  }
